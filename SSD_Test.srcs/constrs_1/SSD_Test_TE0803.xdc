...
# SSD PCI Express reset B25_L4_N (EMIO GPIO 0)
set_property PACKAGE_PIN H12 [get_ports emio_gpio_o[0]]
set_property IOSTANDARD LVCMOS33 [get_ports emio_gpio_o[0]]
